...
inline void configuration::standard( PartitionConfig & partition_config ) {
        ...
        //
        partition_config.do_additional_ls = true;
        partition_config.do_interim_print = true;
        partition_config.print_time       = true;
        partition_config.do_better_evict  = true;
        partition_config.mutation_prob = 0.1;
        partition_config.min_p         = 10;
        partition_config.max_p         = 100;
        partition_config.max_time      = 60;
        partition_config.fraction_pop  = 0.1;
        partition_config.no_iterations = -1;
        partition_config.degree      = 4;
        partition_config.lm_minimum_quality_improvement = 0.001;
        partition_config.lm_number_of_label_propagation_iterations = 3;
        partition_config.lm_number_of_label_propagation_levels = 0;
        partition_config.lm_cluster_coarsening_factor = 0;
        ...
        partition_config.mh_pool_size                           = 100;
